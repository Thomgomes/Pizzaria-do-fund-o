...
function updateCart() {
    ...
    if (cart.length > 0) {
        ...
        c('.cart--area').style.display = 'block'
        c('.cart').innerHTML = ''
        let subtotal = 0
        let desconto = 0
        let total = 0
...
c('.cart-finalizar').addEventListener("click", () => {
    alert("Muito obrigado por escolher a pizzaria do fundão.\nSua compra continuara aberta caso queria comprar novamente. \npara sair fechar, clique no OK ou digite ENTER.")
})